package com.fastcampus.jaavallinone.project3.mycontact.exception.handler;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(RenameNotPermiitedException.class)
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public ErrorResponse handleRenameNoPermittedException(RenameNotPermiitedException ex) {
