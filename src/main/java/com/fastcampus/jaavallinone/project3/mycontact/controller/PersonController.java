...
import com.fastcampus.jaavallinone.project3.mycontact.exception.dto.ErrorResponse;
...
public class PersonController {
  ...
  @ExceptionHandler(value = RenameNotPermiitedException.class)
  public ResponseEntity<ErrorResponse> handleRenameNoPermittedException(
      RenameNotPermiitedException ex) {
    return new ResponseEntity<>(ErrorResponse.of(HttpStatus.BAD_REQUEST, ex.getMessage()),
  ...
  public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException ex) {
    ...
    return new ResponseEntity<>(
        ErrorResponse.of(HttpStatus.INTERNAL_SERVER_ERROR, "알 수 없는 서버 오류가 발생하였습니다."),
